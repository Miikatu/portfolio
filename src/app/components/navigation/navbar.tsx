...
export default function Navbar(navbar: any) {
  return (
    <>
      <div className="py-10 pb-0 h-auto bg-slate-100/20 rounded-3xl px-5 sticky mt-0 top-0 z-50 backdrop-filter backdrop-blur-[15px]">
            ...
            <div className="grid grid-cols-5 py-10 rounded-xl -translate-x-4 -translate-y-4 bg-white">
              <div className="col-start-2 col-span-5 flex ">
                <div className="mr-auto">
                  ...
                  <span className="animate-pulse text-black fol-bold text-2xl">
                    | By {navbar.title}
                  </span>
                </div>
